...
class CreateActivity : AppCompatActivity() {
    ...
    //string unambig lives
    //directory path to location this photo
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = "Choose pics (0 / $numImagesReq)"
            ...
            override fun onPlaceholderCLicked() {
                ...
                else
                {
                    requestPermission(this@CreateActivity,
                        READ_PHOTOS_PERMISSION ,READ_EXTERNAL_PHOTOS_CODE)
                }
            }
    ...
    private fun handleAllImagesUploading(customGameName: String) {
        ...
        for((index, photoUri) in chosenImageUris.withIndex())
        {
            ...
            photoReference.putBytes(imageByteArray)
                .continueWithTask{ photoUploadTask ->
                    ...
                    Log.i(TAG, "Finished uploading $photoUri,uploaded ${uploadedImageUrls.size} ")
    ...
    private fun handleAllImagesUploaded(gameName: String, imageUrls: MutableList<String>) {
        //documents have to live in a collection
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?)
    {
        ...
        supportActionBar?.title = "Choose Pics (${chosenImageUris.size}/ $numImagesReq)"
        btnSave.isEnabled = shouldEnableSaveButton()
    }
